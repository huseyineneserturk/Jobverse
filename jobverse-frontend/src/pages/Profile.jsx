...
import { updateProfile, uploadProfilePhoto, deleteProfilePhoto, updateEducation, changePassword } from '../services/profileApi.js';
...
const Profile = () => {
  ...
  const handleEducationSubmit = async (e) => {
    ...
    try {
      const result = await updateEducation(educationData);
